  ...
  const tiers = [
    {
      ...
      features: [
        ...
        { name: 'AIOS intelligence layer', included: false },
    ...
    },
    {
      ...
      annual: '$1,470/yr',
      annualSavings: 'save 2 months',
      tagline: 'Everything in Starter, plus AIOS \u2014 your business intelligence layer.',
      ...
      features: [
        ...
        { name: 'Conversational commands across your full stack', included: true },
        { name: 'Pipeline queries and deal status on demand', included: true },
        { name: 'CRM logging and updates via Telegram', included: true },
