...
const LAYERS = [
  {
    ...
    fillId: 'f1',
    lblId: 'lbl1',
    lblText: '01 · Client Acquisition · $97/mo',
    lblFill: '#E4A124',
    lblY: 128,
    r: 78,
    strokeDash: '5 4',
  ...
  },
  {
    ...
    fillId: 'f2',
    lblId: 'lbl2',
    lblText: '02 · AIOS · Voice Command · $147/mo',
    lblFill: '#5AAEE8',
    lblY: 93,
    r: 113,
    strokeDash: '5 4',
  ...
  return (
    <div className="w-full text-center">
      ...
      >
        ...
        <circle id="f4" cx="340" cy="215" r="200" fill="url(#rg4)" opacity="0"
          style={{ transition: 'opacity 0.4s ease' }}/>
        <circle id="f3" cx="340" cy="215" r="155" fill="url(#rg3)" opacity="0"
          style={{ transition: 'opacity 0.4s ease' }}/>
        <circle id="f2" cx="340" cy="215" r="113" fill="url(#rg2)" opacity="0"
          style={{ transition: 'opacity 0.4s ease' }}/>
        <circle id="f1" cx="340" cy="215" r="78"  fill="url(#rg1)" opacity="0"
          style={{ transition: 'opacity 0.4s ease' }}/>

        {/* Rings */}
        <circle id="r4" cx="340" cy="215" r="200" fill="none" stroke="#534AB7"
          strokeWidth="1.5" strokeDasharray="6 5" strokeOpacity="0"
          style={{ transition: 'stroke-opacity 0.4s ease' }}/>
        <circle id="r3" cx="340" cy="215" r="155" fill="none" stroke="#0F6E56"
          strokeWidth="1.5" strokeDasharray="6 5" strokeOpacity="0"
          style={{ transition: 'stroke-opacity 0.4s ease' }}/>
        <circle id="r2" cx="340" cy="215" r="113" fill="none" stroke="#185FA5"
          strokeWidth="1.5" strokeDasharray="5 4" strokeOpacity="0"
          style={{ transition: 'stroke-opacity 0.4s ease' }}/>
        <circle id="r1" cx="340" cy="215" r="78"  fill="none" stroke="#BA7517"
          strokeWidth="1.5" strokeDasharray="5 4" strokeOpacity="0"
          style={{ transition: 'stroke-opacity 0.4s ease' }}/>

        {/* Ring labels */}
        <text id="lbl4" x="340" y="5" textAnchor="middle" dominantBaseline="central"
        ...
        <text id="lbl3" x="340" y="50" textAnchor="middle" dominantBaseline="central"
          fontSize="10" fontWeight="500" fontFamily="var(--font-body)" fill="#1DBF96" opacity="0"
          style={{ transition: 'opacity 0.35s ease', pointerEvents: 'none' }}>
          03 · ClientBloom · $497/mo
        </text>
        <text id="lbl2" x="340" y="93" textAnchor="middle" dominantBaseline="central"
          fontSize="10" fontWeight="500" fontFamily="var(--font-body)" fill="#5AAEE8" opacity="0"
          style={{ transition: 'opacity 0.35s ease', pointerEvents: 'none' }}>
          02 · AIOS · Voice Command · $147/mo
        </text>
        <text id="lbl1" x="340" y="128" textAnchor="middle" dominantBaseline="central"
          fontSize="10" fontWeight="500" fontFamily="var(--font-body)" fill="#E4A124" opacity="0"
          style={{ transition: 'opacity 0.35s ease', pointerEvents: 'none' }}>
          01 · Client Acquisition · $97/mo
        </text>

        {/* Halo */}
        <g style={{ transformOrigin: '340px 215px', animation: 'halo-breathe 3s ease-in-out infinite' }}>
          <circle cx="340" cy="215" r="68" fill="url(#halo-grad)"/>
        </g>

        {/* Core */}
        <g style={{ transformOrigin: '340px 215px', animation: 'core-breathe 3s ease-in-out infinite' }}>
          <circle cx="340" cy="215" r="44" fill="#E8600A"/>
          <circle cx="340" cy="215" r="44" fill="none" stroke="#FF9240" strokeWidth="1.5" strokeOpacity="0.65"/>
          <text x="340" y="209" textAnchor="middle" dominantBaseline="central"
            fontSize="9.5" fontWeight="400" fontFamily="var(--font-body)" fill="white" opacity="0.85">
            YOUR
          </text>
          <text x="340" y="222" textAnchor="middle" dominantBaseline="central"
      ...
      {/* Buttons */}
      <div className="flex gap-2 mt-2 mb-3 w-full">
        {LAYERS.map((layer) => (
          <button
            key={layer.id}
